...
This is an enhanced fork of [antoniofaccioli/libreoffice-appimage](https://github.com/antoniofaccioli/libreoffice-appimage) to create Libreoffice AppImages without libfuse2 dependency and full support for AppImageUpdate tools.
